...
insert into prompt_run_credits (created_at, user_id, value)  values ((now() - interval '5 day')::timestamp, tests.get_supabase_uid('test_user3'), 180);
...
select results_eq( 
    ...
    $$, 
    'select 3::bigint as consumed, 0::bigint as added, 397::bigint as balance', 
...
select results_eq( 
    ...
    $$, 
    'select 3::bigint as consumed, 100::bigint as added, 397::bigint as balance', 
